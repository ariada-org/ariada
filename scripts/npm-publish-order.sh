...
#
# See `.changeset/config.json` and `.changeset/README.md` for the
# monorepo release config that supersedes this script.
# ============================================================================
#
...
WARNING: scripts/npm-publish-order.sh is DEPRECATED.
         ...
         See `.changeset/config.json` for the changesets workflow.
