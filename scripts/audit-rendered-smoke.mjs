...
// Used by the orchestrator to verify @ariada-org/scan-report-html + @ariada-org/vpat-html-renderer
// renderers ship WCAG 2.2 AA-conformant output (eat-our-own-dog-food per PRDs).
//
// NOT part of the package test suite — this is a session-time verification helper.

import { chromium } from '/Users/pedro/adopta/node_modules/.pnpm/playwright@1.60.0/node_modules/playwright/index.mjs';
import { readFileSync } from 'node:fs';

const axeSource = readFileSync('/Users/pedro/adopta/node_modules/.pnpm/axe-core@4.11.4/node_modules/axe-core/axe.min.js', 'utf8');
