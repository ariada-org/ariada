...
```bash
npm install @ariada/core-engine
```
...
- [`@ariada/wcag-rules-extended`](../wcag-rules-extended) — production WCAG 2.2 AA rule packs (axe-core extension)
- [`@ariada/evidence-emitter`](../ariada-evidence-emitter) — VPAT / EN 301 549 / DOS-lagen JSON from violations
- [`@ariada/core-playwright`](../core-playwright) — Playwright adapter that produces `UnifiedSnapshot` inputs
