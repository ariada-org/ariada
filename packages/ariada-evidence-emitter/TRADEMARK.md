...
- Mention «Powered by Ariada (evidence emitter)» in their site / docs;
...
- Credit «Originally derived from `@ariada-org/evidence-emitter`» as historical
  attribution;
- Reference the public EUPL-1.2 license terms.

Forks of this package MAY NOT:

- Use any reserved mark in the fork name (e.g. `ariada-evidence-mine` is not
  acceptable; `evidence-emitter-mine` or any non-Ariada-named alternative is);
