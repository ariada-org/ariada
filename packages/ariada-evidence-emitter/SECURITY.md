...
- The VPAT 2.5 / EN 301 549 §11 / Swedish DOS-lagen renderers and the
  filesystem-write path of the emitter.

Out of scope:

- VPAT 2.5 / EN 301 549 §11 specification ambiguities (those are
  upstream-spec issues, not security issues).
...
- Cosmetic issues with emitter output (those are bug reports, not security
  issues).
