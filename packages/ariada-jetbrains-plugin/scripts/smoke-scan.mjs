...
function renderEvidenceReport(smoke, findings) {
  return page('Ariada JetBrains Plugin Evidence Report', `
    <h1>Ariada JetBrains plugin evidence report</h1>
