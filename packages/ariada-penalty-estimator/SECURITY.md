...
in `@ariada/penalty-estimator` — whether that is a way to inject hostile
...
- The package version you observed it in (`pnpm list @ariada/penalty-estimator`).
...
- The published `@ariada/penalty-estimator` npm package.
