...
- Domain names that could create consumer confusion (e.g. `ariada-foo.com`, `ariada-penalty-estimator-pro.com`, `ariada-penalty-estimator-cloud.com`, `ariada-penalty-estimator-official.com`);
...
- Mention «Powered by Ariada (penalty estimator)» in their site / docs;
...
- Use any reserved mark in the fork name (e.g. `ariada-penalty-mine` is not
  acceptable; `penalty-estimator-mine` or any non-Ariada-named alternative is);
