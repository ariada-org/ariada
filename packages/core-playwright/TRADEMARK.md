...
This document records the trademark posture of `@ariada/core-playwright` as an open-source
...
- Reference `@ariada/core-playwright` by package name in their dependency manifest.

Forks of this package MAY:

- Credit «Originally derived from `@ariada/core-playwright`» as historical attribution;
