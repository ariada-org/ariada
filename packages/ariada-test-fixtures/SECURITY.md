...
in `@ariada/test-fixtures` — whether that is a hostile HTML fixture that
...
- The package version you observed it in (`pnpm list @ariada/test-fixtures`).
...
- The published `@ariada/test-fixtures` npm package.
