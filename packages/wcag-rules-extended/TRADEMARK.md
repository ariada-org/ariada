...
- Domain names that could create consumer confusion (e.g. `ariada-foo.com`, `wcag-rules-extended-pro.com`, `wcag-rules-extended-cloud.com`, `wcag-rules-extended-official.com`);
...
- Mention «Powered by Ariada (axe-core extension)» in their site / docs;
...
- Use any reserved mark in the fork name (e.g. `ariada-rules-mine` is not
  acceptable; `wcag-rules-extended-mine` or any non-Ariada-named alternative is);
