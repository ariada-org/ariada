...
- General MDX-renderer vulnerabilities — please report those to the upstream
  `@mdx-js/mdx` maintainers.
...
- Cosmetic issues with statement output (those are bug reports, not security
  issues).
