...
- Domain names that could create consumer confusion (e.g. `ariada-foo.com`, `ariada-statement-generator-pro.com`, `ariada-statement-generator-cloud.com`, `ariada-statement-generator-official.com`);
...
- Mention «Powered by Ariada (statement generator)» in their site / docs;
...
- Credit «Originally derived from `@ariada-org/statement-generator`» as historical
  attribution;
- Reference the public EUPL-1.2 license terms.

Forks of this package MAY NOT:

- Use any reserved mark in the fork name (e.g. `ariada-statement-mine` is not
  acceptable; `statement-generator-mine` or any non-Ariada-named alternative is);
...
_Document version: 0.1 (2026-05-14). Public trademark policy of Agonist Development AB._
