...
def build_scan_report
  ...
  h2_blocks << ["Human next steps", table(["Decision", "Needed from human", "Impact"], [["RubyGems release", "Approve package name and provide credentials/MFA path.", "Public install."], ["Hosted sample URL", "Provide or approve a deployed Jekyll/GitHub Pages fixture.", "Host-surface visual evidence."], ["Commercial packaging", "Decide whether this channel gets hosted retention/upload in this wave.", "Determines paid offer completeness."], ["GitHub Pages docs wording", "Approve explicit safe-mode caveat.", "Avoids overclaim and support burden."], ["Hub update", "Coordinator updates central delivery hub serially.", "This agent intentionally did not edit hub files."]])]
  ...
  body = <<~HTML
    <p class='note'>Generated 2026-07-01 for the Jekyll plugin. Total findings in real shared CLI fixture scan: <strong>#{esc(total)}</strong>. Current screenshot classification: <strong>scan-result preview</strong>.</p>
