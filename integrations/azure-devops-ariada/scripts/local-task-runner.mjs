...
<html lang="en"><head><meta charset="utf-8"><title>Ariada Azure DevOps scan evidence</title>
...
<body><main>
<h1>Ariada Azure DevOps scan evidence</h1>
<div class="grid">
...
<h2>Screenshot</h2><p>Embedded local report screenshot, with direct PNG link: ${link(evidenceHtml, screenshotPath, 'test-report/screenshot.png')}.</p><a href="${esc(relative(dirname(evidenceHtml), screenshotPath))}"><img src="${esc(relative(dirname(evidenceHtml), screenshotPath))}" alt="Screenshot of the Ariada Azure DevOps extension report showing implemented status, blockers, channel rationale, roles, competitors, and domains."></a>
...
<html lang="en"><head><meta charset="utf-8"><title>Ariada Azure DevOps extension report</title>
...
<body><main>
<h1>Ariada Azure DevOps extension report</h1>
