...
node /path/to/adopta/scripts/audit-channel-report.mjs --baseline /path/to/adopta/.worktrees/adopta-s93-dash/integrations/dash-ariada/scan-evidence/result.html --report scan-evidence/result.html --strict</code></pre>`)}
</main>
</body>
</html>
`;
